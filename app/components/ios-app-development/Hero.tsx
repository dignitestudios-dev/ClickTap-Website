  ...
  return (
    <section className="relative bg-white w-full flex flex-col items-center  overflow-hidden" >
      ...
      <div className="relative z-10  mx-auto px-4 flex flex-col items-center text-center gap-4 mt-15">
        ...
        <div >
          <Image src="/images/lead-mob-hero-overlay.png" alt="lead-mob-hero-overlay.png" width={1300} height={1300} className="w-[1300px] absolute  bottom-38 left-1/2 -translate-x-1/2" />
          <Image
            src="/images/hero-lead-mob.png"
            alt="leading-mobile-app.png"
            width={952}
            height={800}
            className="relative z-[1] bottom-16 mx-auto"
          />

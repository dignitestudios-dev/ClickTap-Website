...
const marqueeLogos = ["/images/marquee1.png", "/images/marquee2.png", "/images/marquee3.png", "/images/marquee4.png", "/images/marquee5.png"];
...
export default function TrustPilot() {
    ...
    return (
        <main className=" trust-bg px-6 py-12 text-white md:px-20">
            <section className="mx-auto flex w-full max-w-[1440px] flex-col items-center gap-[60px] overflow-hidden rounded-2xl bg-transparent px-4 py-[60px] md:px-[80px] md:pb-[100px]">
                ...
                <div className="grid w-full grid-cols-1 overflow-hidden rounded-2xl border border-[#dbf7ff1a] bg-[#ffffff05] backdrop-blur-[10px] sm:grid-cols-2 lg:grid-cols-4">
                    {stats.map((item, index) => (
                        ...
                        >
                            <p
                                ...
                                style={{ fontFamily: "Inter Tight, Satoshi, sans-serif" }}
                            >

...
export const MarqueeSection = ({ images, speed = 45, dragSensitivity = 0.08 }: MarqueeSectionProps) => {
    ...
    return (
        <div>
            ...
            {/* Controls */}
            <div className="mt-8 bg-[#0A0A0A] w-[130px] rounded-[16px] h-[65px] mx-auto flex items-center justify-center gap-1">
                <button
                    onClick={scrollLeft}
                    className="flex h-[56px] cursor-pointer w-[56px] rounded-[16px] items-center justify-center   transition-all duration-300 bg-[#262626] text-white"
                >
                    <ChevronLeft size={24} />
                </button>
